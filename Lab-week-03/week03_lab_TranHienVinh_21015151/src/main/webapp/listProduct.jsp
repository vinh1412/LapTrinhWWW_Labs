    ...
    <c:if test="${not empty product}">
        <div class="card" style="width: 18rem; margin-top: 20px;">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Price: <fmt:formatNumber value="${product.price}" type="currency" currencySymbol="VNĐ" /></p>
            </div>
        </div>
    </c:if>
            ...
            <c:forEach var="prod" items="${products}">
                <div class="card" style="width: 18rem; margin-bottom: 20px">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Price: <fmt:formatNumber value="${prod.price}" type="currency" currencySymbol="VNĐ" /></p>
                    </div>
                </div>
            </c:forEach>
        </div>
