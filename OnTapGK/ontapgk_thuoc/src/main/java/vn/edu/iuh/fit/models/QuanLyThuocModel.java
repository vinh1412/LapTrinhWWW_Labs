/*
 * @ {#} QuanLyThuocModel.java   1.0     23/10/2024
 *
 ...
 * @version:    1.0
 */
public class QuanLyThuocModel {
    private final String URL = "http://localhost:8080/ontapgk_thuoc-1.0-SNAPSHOT/api/quanlythuoc";
